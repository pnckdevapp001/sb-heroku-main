...
class Talk(object):
    ...
    @loggedIn
    def lotto(self,to,label,lotto):
        user = self.talk.getProfile().mid
        profile = self.talk.getContact(user)
        data ={"type":"bubble","size":"kilo","body":{"type":"box","layout":"vertical","backgroundColor": "#000000","contents":[{"type":"box","layout":"vertical","contents":[{"type":"box","layout":"vertical","contents":[{"type":"image","url":"https://www.img.in.th/images/98834ff2c77219618b4b24c1cf110009.jpg","aspectRatio":"1:1","aspectMode":"cover"}],"cornerRadius":"100px"}],"alignItems":"center","paddingTop":"50px"},{"type":"box","layout":"vertical","contents":[{"type":"text","text":"บ.สุ่มเสี่ยง lotto","color":"#FFC300","weight":"bold","align":"center"},{"type":"text","text":" 🎀  ᴘɴᴄᴋ ᴅᴀᴠ ᴀᴘᴘ  🎀 ","color":"#FFC300cc","align":"center","size":"xxs"}],"paddingAll":"10px"},{"type":"box","layout":"vertical","contents":[{"type":"text","text":label.upper(),"color":"#FFC300","weight":"bold","size":"xxs"}],"position":"absolute","borderWidth":"1px","borderColor":"#ffffffcc","paddingStart":"8px","paddingEnd":"8px","paddingTop":"5px","paddingBottom":"5px","offsetTop":"10px","offsetStart":"10px","cornerRadius":"20px"},{"type":"box","layout":"vertical","contents":[{"type":"box","layout":"vertical","contents":[{"type":"text","text":lotto,"color":"#FFC300","size":"xs","wrap":True,"align":"center"}],"paddingAll":"20px","backgroundColor":"#111111"}],"paddingAll":"20px","paddingTop":"5px"}],"paddingAll":"0px"},"styles":{"body":{"backgroundColor":"#161e2b"}}}
        return self.sendFlex(to,data)   

    @loggedIn
    def center(self,to,label,menu):
        user = self.talk.getProfile().mid
        profile = self.talk.getContact(user)
        data ={"type":"bubble","size":"kilo","body":{"type":"box","layout":"vertical","backgroundColor":"#000000","contents":[{"type":"box","layout":"vertical","contents":[{"type":"box","layout":"vertical","contents":[{"type":"image","url":"https://www.img.in.th/images/98834ff2c77219618b4b24c1cf110009.jpg","aspectRatio":"1:1","aspectMode":"cover"}],"cornerRadius":"100px"}],"alignItems":"center","paddingTop":"50px"},{"type":"box","layout":"vertical","contents":[{"type":"text","text":"{}".format(profile.displayName),"color":"#FFC300","weight":"bold","align":"center"},{"type":"text","text":" 🎀  ᴘɴᴄᴋ ᴅᴀᴠ ᴀᴘᴘ  🎀 ","color":"#FFC300cc","align":"center","size":"xxs"}],"paddingAll":"10px"},{"type":"box","layout":"vertical","contents":[{"type":"text","text":label.upper(),"color":"#FFC300","weight":"bold","size":"xxs"}],"position":"absolute","borderWidth":"1px","borderColor":"#ffffffcc","paddingStart":"8px","paddingEnd":"8px","paddingTop":"5px","paddingBottom":"5px","offsetTop":"10px","offsetStart":"10px","cornerRadius":"20px"},{"type":"box","layout":"vertical","contents":[{"type":"box","layout":"vertical","contents":[{"type":"text","text":menu,"color":"#FFC300","size":"xs","wrap":True,"align":"center"}],"paddingAll":"20px","backgroundColor":"#111111"}],"paddingAll":"20px","paddingTop":"5px"}],"paddingAll":"0px"},"styles":{"body":{"backgroundColor":"#161e2b"}}}
        self.sendFlex(to,data)

    @loggedIn
    def bcavx(self,to,label,menu):
        user = self.talk.getProfile().mid
        profile = self.talk.getContact(user)
        data = {"type": "bubble", "size": "kilo", "body": {"type": "box", "layout": "vertical", "backgroundColor": "#000000", "contents": [{"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": label, "color": "#FFC300", "weight": "bold", "size": "xxs"}], "position": "absolute", "offsetTop": "15px", "offsetStart": "15px", "borderWidth": "1px", "borderColor": "#FFC300", "cornerRadius": "50px", "paddingStart": "7px", "paddingEnd": "7px", "paddingTop": "2px", "paddingBottom": "2px"}, {"type": "box", "layout": "vertical", "contents": [{"type": "box", "layout": "vertical", "contents": [{"type": "image", "url": "https://www.img.in.th/images/8d8a98f486d4e22cf0cf0d80340bfc7d.png", "aspectRatio": "1:1", "aspectMode": "cover", "action": {
                            "type": "uri", "uri": "https://www.img.in.th/images/8d8a98f486d4e22cf0cf0d80340bfc7d.png"}}], "cornerRadius": "100px"}], "alignItems": "center", "paddingTop": "20px"}, {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": "ประกาศจาก กำนันหมู่ 2", "weight": "bold", "size": "md", "color": "#FFC300"}, {"type": "text", "text": "Im ChangYed เธอจะให้เราเย็ดหรือช้างเย็ด", "color": "#FFC300cc", "size": "xxs"}], "alignItems": "center", "paddingTop": "10px"}, {"type": "box", "layout": "vertical", "contents": [{"type": "text", "text": menu, "color": "#FFC300", "size": "xs", "wrap": True}], "paddingTop": "15px", "paddingBottom": "5px"}], "paddingAll": "10px", "paddingStart": "15px", "paddingEnd": "15px", "paddingBottom": "10px"}}
        self.sendFlex(to,data)
    ...
    def sendFlexText(self, to, text):
        ...
        data = {
            'messages': [{
                ...
                'sentBy': {
                    'label': 'PNCK DEV APP',
                    'iconUrl': f'https://clip.avfreex24.com/wp-content/uploads/2022/06/logoChang.png',
                    'linkUrl': 'https://{}'.format("avfreex24.com/")
                }
            }]
        }
    ...
    def sendFlexAudio(self, to, link):
        ...
        res = requests.post(url, headers=headers, data=json.dumps(data))
        return res
#https://clip.avfreex24.com/wp-content/uploads/2022/06/L3.png ไม่เซ็น
#https://clip.avfreex24.com/wp-content/uploads/2022/06/L2.png เซ็น
#https://clip.avfreex24.com/wp-content/uploads/2022/06/L1.png ไทย
    @loggedIn
    def sendFlexVideo(self, to, videoUrl, thumbnail='dark'):
        main = ["dark","red","cyan","yellow","green","white"]
        if thumbnail in main:
           thumbnail = f"https://clip.avfreex24.com/wp-content/uploads/2022/06/L2.png"
        xyz = LiffChatContext(to)
        xyzz = LiffContext(chat=xyz)
        view = LiffViewRequest('1602876096-e9QWgjyo', xyzz)
        token = self.liff.issueLiffView(view)
    ...
    def sendPage(self, to):
        contentMetadata = {'mid': 'ue541b98a9bd8d25e5388ff9a1378ece2'}
        return self.sendMessage(to, '', contentMetadata, 13)
